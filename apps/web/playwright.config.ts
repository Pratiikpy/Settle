  ...
  projects: [
    {
      ...
      testIgnore: /(demo-recorder(-(wallet|broll|landing))?|autonomous-judge|phantom-(real|signing|everything|multiwallet|final-mile|iter4|iter5|iter6|iter8-verify|iter9|iter10|iter11|iter12|iter13|iter14|iter15|iter16|iter18|iter19|iter20|iter21|iter22))\.spec\.ts$/,
    },
    {
    ...
    },
    {
      ...
      retries: 0,
      testMatch: /phantom-(real|signing|everything|multiwallet|final-mile|iter4|iter5|iter6|iter8-verify|iter9|iter10|iter11|iter12|iter13|iter14|iter15|iter16|iter18|iter19|iter20|iter21|iter22)\.spec\.ts$/,
    },
  ],
});
