...
- Name: section-23b-A-extended.spec.ts >> §23b.A extended · consumer matrix >> 23b.A77 — settings /settings
- Location: e2e\section-23b-A-extended.spec.ts:185:5

# Error details

```
Error: apiRequestContext._wrapApiCall: ENOENT: no such file or directory, open 'C:\Users\prate\Downloads\solana\settle-protocol\apps\web\test-results\.playwright-artifacts-172\traces\70cbc0b19fb07d6da69d-b4dce5a79b89d93c6409-recording1.trace'
```
